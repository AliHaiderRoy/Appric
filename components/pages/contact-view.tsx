...
import { DEFAULT_CONTACT } from "@/lib/cms/fallbacks"

interface ContactViewProps {
  contact?: ContactContent
}

export function ContactView({ contact = DEFAULT_CONTACT }: ContactViewProps) {
  ...
  const lastWord = headingParts.pop() ?? "Touch"
  const headingPrefix = headingParts.join(" ") || "Get in"
        ...
        <section className="py-20 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <p className="text-xl text-gray-300 leading-relaxed text-balance">{contact.subheading}</p>
            </motion.div>
          </div>
        </section>
                ...
                <div className="p-6 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 backdrop-blur-sm border border-white/10 rounded-xl">
                  ...
                  <div className="space-y-2 text-gray-300">
                    <div className="flex justify-between">
                      ...
                      <span className="text-cyan-400">{hours.weekdays}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Saturday</span>
                      <span className="text-cyan-400">{hours.saturday}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Sunday</span>
                      <span className={hours.sunday === "Closed" ? "text-gray-500" : "text-cyan-400"}>
                        {hours.sunday}
                      </span>
                    </div>
                  </div>
